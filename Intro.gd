...
func _on_Mode_pressed():
	if Global_Vars.gameMode == Global_Vars.STORY:
		$VBoxContainer/HBox/Mode.text = "Mode: Arena"
		Global_Vars.gameMode = 0
	elif Global_Vars.gameMode == Global_Vars.ARENA:
		$VBoxContainer/HBox/Mode.text = "Mode: Puzzle"
		Global_Vars.gameMode += 1
	elif Global_Vars.gameMode == Global_Vars.PUZZLE:
		$VBoxContainer/HBox/Mode.text = "Mode: Story"
		Global_Vars.gameMode += 1